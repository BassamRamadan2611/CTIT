...
@Component({
  selector: 'app-data-transfer-confirm-email',
  templateUrl: './data-transfer-confirm-email.component.html',
  styleUrls: ['./data-transfer-confirm-email.component.css']
})
export class DataTransferConfirmEmailComponent {
