...
@Component({
  selector: 'app-email-hosting-packages',
  templateUrl: './email-hosting-packages.component.html',
  styleUrls: ['./email-hosting-packages.component.css']
})
export class EmailHostingPackagesComponent {
  cards: Packages[] = [];
  countries: Country[] = [];
