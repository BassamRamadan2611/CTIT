...
@Component({
  selector: 'app-email-hosting-adds',
  templateUrl: './email-hosting-adds.component.html',
  styleUrls: ['./email-hosting-adds.component.css']
})
export class EmailHostingAddsComponent {
  cards: Packages[] = [];
