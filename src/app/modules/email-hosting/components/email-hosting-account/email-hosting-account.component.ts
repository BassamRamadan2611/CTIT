...
@Component({
  selector: 'app-email-hosting-account',
  templateUrl: './email-hosting-account.component.html',
  styleUrls: ['./email-hosting-account.component.css']
})
export class EmailHostingAccountComponent {
