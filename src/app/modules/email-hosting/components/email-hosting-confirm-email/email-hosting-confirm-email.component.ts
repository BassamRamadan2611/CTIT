...
@Component({
  selector: 'app-email-hosting-confirm-email',
  templateUrl: './email-hosting-confirm-email.component.html',
  styleUrls: ['./email-hosting-confirm-email.component.css']
})
export class EmailHostingConfirmEmailComponent {
